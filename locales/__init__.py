...
SPEAKING_TRANSLATIONS = {
    "en": {
        "speaking": "Speaking",
        "speaking_description": "Respond aloud in useful real-life conversations.",
        "speaking_title": "Speaking Practice",
        "speaking_instructions": "Read the situation, listen to your partner, then record an appropriate reply in the language you are learning. An incorrect reply costs one heart.",
        "speaking_round": "Conversation {current} of {total}",
        "speaking_situation": "Situation",
        "speaking_partner_says": "Your partner says",
        "speaking_your_turn": "Your turn — reply in {target_language}",
        "speaking_show_help": "Show a reply hint",
        "speaking_reply_meaning": "Your reply should mean",
        "speaking_first_words": "Start with",
        "speaking_record_tip": "Answer naturally. You do not need to copy one exact sentence.",
        "speaking_record_label": "Record your reply",
        "speaking_privacy": "Your recording is sent to Google Speech Recognition for transcription and is not saved on this screen.",
        "speaking_check_reply": "Check my reply",
        "speaking_listening_to_you": "Listening to your reply...",
        "speaking_feedback": "Conversation feedback",
        "speaking_record_again": "Record again",
        "speaking_heard": "WordFluent heard",
        "speaking_match": "Reply match: {score}% · {required}% needed for this difficulty",
        "speaking_correct": "That reply works! You earned {reward} coins.",
        "speaking_try_another_reply": "That reply does not fit this situation yet. Listen to the model reply and try again.",
        "speaking_model_reply": "A good reply",
        "speaking_say_it_like": "Say it like",
        "speaking_next_scene": "Next conversation",
        "speaking_skip_scene": "Skip this conversation",
        "speaking_score": "Speaking score",
        "speaking_replies_correct": "{correct} of {total} replies accepted",
    },
    "bn": {
        "speaking": "কথা বলা",
        "speaking_description": "বাস্তব কথোপকথনে নিজের কণ্ঠে দরকারি উত্তর দিন।",
        "speaking_title": "কথা বলার অনুশীলন",
        "speaking_instructions": "পরিস্থিতিটি পড়ুন, সঙ্গীর কথা শুনুন, তারপর শেখা ভাষায় উপযুক্ত উত্তর রেকর্ড করুন। ভুল উত্তরে একটি হার্ট কমবে।",
        "speaking_round": "কথোপকথন {current} / {total}",
        "speaking_situation": "পরিস্থিতি",
        "speaking_partner_says": "আপনার সঙ্গী বলছেন",
        "speaking_your_turn": "এবার আপনার পালা — {target_language} ভাষায় উত্তর দিন",
        "speaking_show_help": "উত্তরের ইঙ্গিত দেখুন",
        "speaking_reply_meaning": "আপনার উত্তরের অর্থ হবে",
        "speaking_first_words": "এভাবে শুরু করুন",
        "speaking_record_tip": "স্বাভাবিকভাবে উত্তর দিন। হুবহু একই বাক্য বলতে হবে না।",
        "speaking_record_label": "আপনার উত্তর রেকর্ড করুন",
        "speaking_privacy": "লিখিত রূপ তৈরির জন্য আপনার রেকর্ডিং Google Speech Recognition-এ পাঠানো হয় এবং এই স্ক্রিনে সংরক্ষণ করা হয় না।",
        "speaking_check_reply": "আমার উত্তর যাচাই করুন",
        "speaking_listening_to_you": "আপনার উত্তর শোনা হচ্ছে...",
        "speaking_feedback": "কথোপকথনের প্রতিক্রিয়া",
        "speaking_record_again": "আবার রেকর্ড করুন",
        "speaking_heard": "WordFluent শুনেছে",
        "speaking_match": "উত্তরের মিল: {score}% · এই কঠিনতার জন্য দরকার {required}%",
        "speaking_correct": "এই উত্তরটি ঠিক! আপনি {reward}টি কয়েন পেয়েছেন।",
        "speaking_try_another_reply": "উত্তরটি এখনো এই পরিস্থিতির সঙ্গে মেলেনি। নমুনা উত্তর শুনে আবার চেষ্টা করুন।",
        "speaking_model_reply": "একটি ভালো উত্তর",
        "speaking_say_it_like": "এভাবে বলুন",
        "speaking_next_scene": "পরবর্তী কথোপকথন",
        "speaking_skip_scene": "এই কথোপকথনটি এড়িয়ে যান",
        "speaking_score": "কথা বলার স্কোর",
        "speaking_replies_correct": "{total}টির মধ্যে {correct}টি উত্তর গৃহীত",
    },
    "hi": {
        "speaking": "बोलना",
        "speaking_description": "रोज़मर्रा की बातचीत में अपनी आवाज़ से उपयोगी जवाब दें।",
        "speaking_title": "बोलने का अभ्यास",
        "speaking_instructions": "स्थिति पढ़ें, सामने वाले की बात सुनें, फिर सीखी जा रही भाषा में सही जवाब रिकॉर्ड करें। गलत जवाब पर एक हार्ट कम होगा।",
        "speaking_round": "बातचीत {current} / {total}",
        "speaking_situation": "स्थिति",
        "speaking_partner_says": "सामने वाला कहता है",
        "speaking_your_turn": "अब आपकी बारी — {target_language} में जवाब दें",
        "speaking_show_help": "जवाब का संकेत दिखाएँ",
        "speaking_reply_meaning": "आपके जवाब का अर्थ होना चाहिए",
        "speaking_first_words": "इससे शुरू करें",
        "speaking_record_tip": "स्वाभाविक रूप से जवाब दें। बिल्कुल वही वाक्य बोलना ज़रूरी नहीं है।",
        "speaking_record_label": "अपना जवाब रिकॉर्ड करें",
        "speaking_privacy": "लिखित रूप बनाने के लिए आपकी रिकॉर्डिंग Google Speech Recognition को भेजी जाती है और इस स्क्रीन पर सहेजी नहीं जाती।",
        "speaking_check_reply": "मेरा जवाब जाँचें",
        "speaking_listening_to_you": "आपका जवाब सुना जा रहा है...",
        "speaking_feedback": "बातचीत पर प्रतिक्रिया",
        "speaking_record_again": "फिर से रिकॉर्ड करें",
        "speaking_heard": "WordFluent ने सुना",
        "speaking_match": "जवाब का मिलान: {score}% · इस कठिनाई के लिए {required}% चाहिए",
        "speaking_correct": "यह जवाब सही है! आपने {reward} सिक्के कमाए।",
        "speaking_try_another_reply": "यह जवाब अभी इस स्थिति से मेल नहीं खाता। नमूना जवाब सुनें और फिर कोशिश करें।",
        "speaking_model_reply": "एक अच्छा जवाब",
        "speaking_say_it_like": "ऐसे बोलें",
        "speaking_next_scene": "अगली बातचीत",
        "speaking_skip_scene": "यह बातचीत छोड़ें",
        "speaking_score": "बोलने का स्कोर",
        "speaking_replies_correct": "{total} में से {correct} जवाब स्वीकार हुए",
    },
    "fr": {
        "speaking": "Expression orale",
        "speaking_description": "Répondez à voix haute dans des conversations de la vie courante.",
        "speaking_title": "Exercice d’expression orale",
        "speaking_instructions": "Lisez la situation, écoutez votre interlocuteur, puis enregistrez une réponse adaptée dans la langue étudiée. Une mauvaise réponse coûte un cœur.",
        "speaking_round": "Conversation {current} sur {total}",
        "speaking_situation": "Situation",
        "speaking_partner_says": "Votre interlocuteur dit",
        "speaking_your_turn": "À vous — répondez en {target_language}",
        "speaking_show_help": "Afficher un indice de réponse",
        "speaking_reply_meaning": "Votre réponse doit vouloir dire",
        "speaking_first_words": "Commencez par",
        "speaking_record_tip": "Répondez naturellement. Vous n’avez pas besoin de répéter une phrase exacte.",
        "speaking_record_label": "Enregistrez votre réponse",
        "speaking_privacy": "Votre enregistrement est envoyé à Google Speech Recognition pour être transcrit et n’est pas conservé sur cet écran.",
        "speaking_check_reply": "Vérifier ma réponse",
        "speaking_listening_to_you": "Écoute de votre réponse...",
        "speaking_feedback": "Retour sur la conversation",
        "speaking_record_again": "Enregistrer à nouveau",
        "speaking_heard": "WordFluent a entendu",
        "speaking_match": "Correspondance : {score}% · {required}% requis pour cette difficulté",
        "speaking_correct": "Cette réponse convient ! Vous avez gagné {reward} pièces.",
        "speaking_try_another_reply": "Cette réponse ne convient pas encore à la situation. Écoutez la réponse modèle et réessayez.",
        "speaking_model_reply": "Une bonne réponse",
        "speaking_say_it_like": "Prononcez ainsi",
        "speaking_next_scene": "Conversation suivante",
        "speaking_skip_scene": "Passer cette conversation",
        "speaking_score": "Score d’expression orale",
        "speaking_replies_correct": "{correct} réponses acceptées sur {total}",
    },
}

SPEAKING_TRANSLATIONS.update({
    "es": {
        "speaking": "Expresión oral",
        "speaking_description": "Responde en voz alta en conversaciones de la vida real.",
        "speaking_title": "Práctica de expresión oral",
        "speaking_instructions": "Lee la situación, escucha a la otra persona y graba una respuesta adecuada en el idioma que aprendes. Una respuesta incorrecta cuesta un corazón.",
        "speaking_round": "Conversación {current} de {total}",
        "speaking_situation": "Situación",
        "speaking_partner_says": "La otra persona dice",
        "speaking_your_turn": "Tu turno — responde en {target_language}",
        "speaking_show_help": "Mostrar una pista para responder",
        "speaking_reply_meaning": "Tu respuesta debe significar",
        "speaking_first_words": "Empieza con",
        "speaking_record_tip": "Responde de forma natural. No tienes que repetir una frase exacta.",
        "speaking_record_label": "Graba tu respuesta",
        "speaking_privacy": "Tu grabación se envía a Google Speech Recognition para transcribirla y no se guarda en esta pantalla.",
        "speaking_check_reply": "Comprobar mi respuesta",
        "speaking_listening_to_you": "Escuchando tu respuesta...",
        "speaking_feedback": "Comentarios de la conversación",
        "speaking_record_again": "Grabar de nuevo",
        "speaking_heard": "WordFluent escuchó",
        "speaking_match": "Coincidencia: {score}% · se necesita {required}% para esta dificultad",
        "speaking_correct": "¡Esa respuesta funciona! Ganaste {reward} monedas.",
        "speaking_try_another_reply": "La respuesta aún no encaja en esta situación. Escucha la respuesta modelo e inténtalo otra vez.",
        "speaking_model_reply": "Una buena respuesta",
        "speaking_say_it_like": "Pronúncialo así",
        "speaking_next_scene": "Siguiente conversación",
        "speaking_skip_scene": "Saltar esta conversación",
        "speaking_score": "Puntuación oral",
        "speaking_replies_correct": "{correct} de {total} respuestas aceptadas",
    },
    "ko": {
        "speaking": "말하기",
        "speaking_description": "실생활 대화에서 알맞은 답을 소리 내어 말해 보세요.",
        "speaking_title": "말하기 연습",
        "speaking_instructions": "상황을 읽고 상대방의 말을 들은 뒤, 배우는 언어로 알맞은 답을 녹음하세요. 틀린 답은 하트 하나를 차감합니다.",
        "speaking_round": "대화 {current} / {total}",
        "speaking_situation": "상황",
        "speaking_partner_says": "상대방의 말",
        "speaking_your_turn": "이제 여러분 차례예요 — {target_language}로 답하세요",
        "speaking_show_help": "답변 힌트 보기",
        "speaking_reply_meaning": "답변의 뜻",
        "speaking_first_words": "이 말로 시작하세요",
        "speaking_record_tip": "자연스럽게 답하세요. 문장을 그대로 따라 할 필요는 없습니다.",
        "speaking_record_label": "답변 녹음하기",
        "speaking_privacy": "녹음은 받아쓰기를 위해 Google Speech Recognition으로 전송되며 이 화면에는 저장되지 않습니다.",
        "speaking_check_reply": "내 답변 확인",
        "speaking_listening_to_you": "답변을 듣는 중...",
        "speaking_feedback": "대화 피드백",
        "speaking_record_again": "다시 녹음",
        "speaking_heard": "WordFluent가 들은 말",
        "speaking_match": "답변 일치도: {score}% · 이 난이도에서는 {required}% 필요",
        "speaking_correct": "알맞은 답변이에요! 코인 {reward}개를 획득했습니다.",
        "speaking_try_another_reply": "아직 상황에 맞는 답변이 아닙니다. 예시 답변을 듣고 다시 해 보세요.",
        "speaking_model_reply": "좋은 답변 예시",
        "speaking_say_it_like": "이렇게 발음해요",
        "speaking_next_scene": "다음 대화",
        "speaking_skip_scene": "이 대화 건너뛰기",
        "speaking_score": "말하기 점수",
        "speaking_replies_correct": "{total}개 중 {correct}개 답변 인정",
    },
    "ja": {
        "speaking": "スピーキング",
        "speaking_description": "日常会話で、声に出して適切に答えましょう。",
        "speaking_title": "スピーキング練習",
        "speaking_instructions": "場面を読み、相手の言葉を聞いて、学習中の言語で適切な返事を録音してください。間違えるとハートが1つ減ります。",
        "speaking_round": "会話 {current} / {total}",
        "speaking_situation": "場面",
        "speaking_partner_says": "相手の言葉",
        "speaking_your_turn": "あなたの番です — {target_language}で答えてください",
        "speaking_show_help": "返事のヒントを表示",
        "speaking_reply_meaning": "返事の意味",
        "speaking_first_words": "この言葉から始めましょう",
        "speaking_record_tip": "自然に答えてください。まったく同じ文を言う必要はありません。",
        "speaking_record_label": "返事を録音",
        "speaking_privacy": "録音は文字起こしのためGoogle Speech Recognitionに送信され、この画面には保存されません。",
        "speaking_check_reply": "返事を確認",
        "speaking_listening_to_you": "返事を聞いています...",
        "speaking_feedback": "会話のフィードバック",
        "speaking_record_again": "もう一度録音",
        "speaking_heard": "WordFluentが聞き取った内容",
        "speaking_match": "返事の一致度：{score}% · この難易度には{required}%必要",
        "speaking_correct": "その返事で大丈夫です！{reward}コインを獲得しました。",
        "speaking_try_another_reply": "まだこの場面に合っていません。お手本を聞いて、もう一度試しましょう。",
        "speaking_model_reply": "よい返事の例",
        "speaking_say_it_like": "このように発音",
        "speaking_next_scene": "次の会話",
        "speaking_skip_scene": "この会話をスキップ",
        "speaking_score": "スピーキングスコア",
        "speaking_replies_correct": "{total}件中{correct}件の返事が合格",
    },
})

for _language_code, _strings in SPEAKING_TRANSLATIONS.items():
    TRANSLATIONS.setdefault(_language_code, {}).update(_strings)